...
with st.sidebar:
    selected = option_menu('Multiple Disease Predictoin System', ['Diabetes Prediction', 'Heart Disease Prediction',
...
if selected == 'Heart Disease Prediction':
    ...
    if st.button('Heart Disease Test Result'):
        arr = np.array([[int(age), int(sex), int(cp), int(trestbps), int(chol), int(fbs), int(restecg), int(thalach),
...
if selected == "Parkinsons Prediction":
    ...
    if st.button("Parkinson's Test Result"):
        parkinsons_pred = parkinsons_model.predict([[fo, fhi, flo, Jitter_percent, Jitter_Abs, RAP, PPQ, DDP,
